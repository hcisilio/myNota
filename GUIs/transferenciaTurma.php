...
<body>
	...
	<div id="principal">
		...
		<div id="barra">
			<ul>
				<li> <a href="javaScript:doPost('aluno_turma');"> Transferir </a>  </li>           
			</ul>
		</div>
		...
		<div id="formulario">
			<form id="aluno_turma" action="../Controladores/controlador.php" method="post">
				...
				<input type="hidden" name="metodo" value="transferir">
				...
				<?php
					...
					echo "</select>";
				?> <br>				
			<input type="text" name="novaTurma" id="novaTurma" class="edits"> <br/>
			</form>
		</div>
		<div class="clear"> </div>
