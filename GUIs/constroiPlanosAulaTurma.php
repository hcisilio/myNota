...
if ($turma->getId()){
	...
	$txt .= "<tr> <th colspan='6' align='center'> Turma: ".$turma->getId(). " | Dia da aula: ".$dias." </th> </tr>";
	$txt .= "<tr> <th> Módulo </th> <th> Conteúdo </th> <th> Professor </th> <th> Data </th> <th> Remover </th> <th> Imprimir </th> </tr>";
	...
	if (count($planos) > 0) {
		foreach($planos as $plano){
			...
			$txt .= "<td> <img src='Imagens/print.png' height='30px' onclick='imprimePlano($id)'> </td> ";
		...
		$txt .= "<tr> <td colspan='6' align='center'> A turma ".$turma->getId()." ainda não possui plano de aula cadatrado! </td> </tr>";
	}
	$txt .= "</table>";
