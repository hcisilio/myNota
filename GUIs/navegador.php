	...
	<nav class="navbar navbar-default" role="navigation" id="barra">
		<div class="container-fluid">
			<div class="navbar-header">
				<h1 class="navbar-text navbar-center"> Este sistema funciona apenas no google Chrome. Clique no ícone para fazer o download </h1>
			</div>
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">	
					<li> <a href="http://www.google.com.br/chrome"> <img src="Imagens/Google_Chrome.png"> </a></li>				         
				</ul>
			</div>
		</div>
	</nav>
